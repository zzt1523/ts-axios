...
describe('mergeConfig', () => {
  ...
  test('should accept undefinded for second argument', () => {
  ...
  test('should return default headers if pass config2 with undefinded', () => {
    expect(
      mergeConfig(
        {
  ...
  test('should merge autho, headers with defaults', () => {
    expect(
      mergeConfig(
        {
          auth: undefined
